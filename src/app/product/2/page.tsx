      ...
      >
        ...
        <div>
          <Image
            ...
            width={200}
            height={400}
            src={`/flux-animation/${String(frameNumber).padStart(4, "0")}.png`}
            style={{ width: "67vw" }}
          ></Image>
        </div>
        <Image
      ...
      >
        <div style={{ padding: "2vw 6vw 0 6vw" }}>
          <h1 style={{ fontSize: "6vw", lineHeight: "1.2" }}>
            FLUX<br></br>MANIPULATOR
          </h1>
          <p
            className="oxanium"
            style={{ fontSize: "2.67vw", marginTop: "2vw", color: "#bbb" }}
          >
            FOREARM IMPLANTS CAPABLE OF GENERATING LOCALIZED ELECTROMAGNETIC
            FIELDS. THEY GIVE YOU CONTROL OVER YOUR PHYSICAL ENVIRONMENT:
            LIFTING, REPELLING, OR STABILIZING OBJECTS: ALL POWERED BY THOUGHT
            AND MOTION.
          </p>
        </div>
        <Image
